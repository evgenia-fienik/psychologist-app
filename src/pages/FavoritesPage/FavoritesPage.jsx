...
export default function FavoritesPage() {
    ...
    const getFiltered = () => {
        switch (filter) {
            case "A to Z": return [...favorites].sort((a, b) => a.name.localeCompare(b.name));
            case "Z to A": return [...favorites].sort((a, b) => b.name.localeCompare(a.name));
            case "Popular": return [...favorites].sort((a, b) => b.rating - a.rating);
            case "Not popular": return [...favorites].sort((a, b) => a.rating - b.rating);
            case "Less than 10$": return favorites.filter((p) => p.price_per_hour < 10);
            case "Greater than 10$": return favorites.filter((p) => p.price_per_hour > 10);
