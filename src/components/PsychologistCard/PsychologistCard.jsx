...
export default function PsychologistCard({ psychologist, isFavorite, onToggleFavorite, isLoggedIn }) {
...
const handleHeartClick = () => {
  if (!isLoggedIn) {
    alert("This feature is available for authorized users only. Please log in.");
    return;
  }
            ...
            <div className={styles.content}>
                ...
                {expanded && (
                    <div className={styles.reviews}>
                        ...
                        <button type="button" className={styles.appointmentBtn} onClick={() => setShowModal(true)}>
                            Make an appointment
                        </button>

                        {showModal && (<AppointmentModal psychologist={psychologist} onClose={()=> setShowModal(false)
